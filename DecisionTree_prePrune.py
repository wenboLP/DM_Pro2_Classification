...
def build_tree_preprune(data,labels, threshold_gini = 0.0):
    tree = {}
    ...
    tree['_left'] = build_tree_preprune(data_left,labels_left) # larger
    tree['_right'] = build_tree_preprune(data_right, labels_right) # less
    return tree
...
if __name__ == "__main__":
    ...
    tree_data = build_tree_preprune(data,labels, threshold_gini = 0.0)
